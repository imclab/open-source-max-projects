{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 40.0, 53.0, 754.0, 555.0 ],
		"bglocked" : 0,
		"defrect" : [ 40.0, 53.0, 754.0, 555.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 35.0, 102.0, 143.0, 20.0 ],
					"outlettype" : [ "", "", "" ],
					"id" : "obj-41",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.0, 400.0, 102.0, 18.0 ],
					"id" : "obj-28",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 305.0, 427.0, 32.5, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-39",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 319.0, 403.0, 32.5, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-40",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 278.0, 35.0, 18.0 ],
					"id" : "obj-6",
					"fontname" : "Helvetica Bold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 242.0, 294.0, 35.0, 18.0 ],
					"id" : "obj-5",
					"fontname" : "Helvetica Bold"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 305.0, 460.0, 67.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 483.0, 405.0, 84.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-22",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 305.0, 362.0, 138.0, 20.0 ],
					"outlettype" : [ "signal", "" ],
					"id" : "obj-35",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 2,
					"patching_rect" : [ 483.0, 362.0, 138.0, 20.0 ],
					"outlettype" : [ "signal", "" ],
					"id" : "obj-36",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 484.0, 64.0, 20.0 ],
					"id" : "obj-37",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 344.0, 307.0, 41.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 342.0, 331.0, 177.0, 20.0 ],
					"id" : "obj-15",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 352.0, 283.0, 45.0, 20.0 ],
					"id" : "obj-16",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 305.0, 331.0, 36.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-11",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 1,
					"patching_rect" : [ 305.0, 307.0, 38.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-10",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 305.0, 283.0, 46.0, 20.0 ],
					"outlettype" : [ "signal" ],
					"id" : "obj-9",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 644.0, 520.0, 37.0, 20.0 ],
					"id" : "obj-43",
					"fontname" : "Arial",
					"saved_object_attributes" : 					{
						"attr_comment" : ""
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 33.0, 292.0, 246.0, 206.0 ],
					"border" : 2,
					"id" : "obj-42",
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 299.0, 398.0, 166.0, 53.0 ],
					"border" : 2,
					"id" : "obj-45",
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"bgcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"patching_rect" : [ 291.0, 276.0, 389.0, 234.0 ],
					"border" : 2,
					"id" : "obj-8",
					"rounded" : 10
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 44.5, 515.5, 653.5, 515.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"color" : [ 1.0, 0.611765, 0.611765, 1.0 ],
					"midpoints" : [ 402.5, 104.0, 611.5, 104.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 314.5, 356.0, 492.5, 356.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 492.5, 456.0, 362.5, 456.0 ]
				}
