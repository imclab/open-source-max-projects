...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.0, 2.0, 159.0, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-45",
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 112.0, 111.0, 50.0, 20.0 ],
					"outlettype" : [ "int", "bang" ],
					"id" : "obj-42",
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "preset",
					"patching_rect" : [ 412.0, 49.0, 44.0, 16.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "ezdac~",
					"patching_rect" : [ 359.0, 710.0, 45.0, 45.0 ],
					"id" : "obj-29",
					"numinlets" : 2,
					"numoutlets" : 0
				}
...
, 			{
				"box" : 				{
					"maxclass" : "button",
					"patching_rect" : [ 31.0, 35.0, 20.0, 20.0 ],
					"outlettype" : [ "bang" ],
					"id" : "obj-27",
					"numinlets" : 1,
					"numoutlets" : 1
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "info~ foo",
					"patching_rect" : [ 31.0, 73.0, 113.5, 20.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "groove~ foo",
					"patching_rect" : [ 223.0, 107.0, 74.0, 20.0 ],
					"outlettype" : [ "signal", "signal" ],
					"id" : "obj-4",
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "buffer~ foo",
					"patching_rect" : [ 56.0, 31.0, 68.0, 20.0 ],
					"outlettype" : [ "float", "bang" ],
					"id" : "obj-1",
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 363.0, 696.0, 368.5, 696.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 232.5, 177.0, 61.0, 177.0, 61.0, 432.0, 89.0, 432.0 ]
				}
